...
def is_win(player):
    ...
    Parameters:
    - player:str - player ('X' or 'O') to check a winner

    Returns:
    - bool: if the player wins is True, and if none of the players win is False
    '''
    for i in range(3):
...
def tally_wins(results):
    '''check from a list of result the number of wins
...
def main():
    '''main function control the game'''
    current_player = 'X'
    moves = 0
    results = []
